...
def main() -> None:
    ...
    # Must match aruco_dictionary in config/marker_detection.yaml. Verified against the
    # physical/simulation marker set in aruco.zip: every provided marker (IDs 1-15) decodes
    # uniquely under DICT_4X4_50.
    ...
    print(output)
    print("Print this marker so its outer black border measures 0.21 x 0.21 m "
          "(config/marker_detection.yaml: marker_size_m) -- any other printed size "
          "will silently produce physically incorrect PnP distances.")
