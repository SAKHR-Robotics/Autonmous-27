...
def launch_setup(context, *args, **kwargs):
    ...
    testing_args = ['--config', config_file, '--benchmark_config', bench_config_file, '--use_astar', use_astar_str]
    if scenario_id:
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'use_astar',
            default_value='true',
            description='If true, use A* pathfinding. If false, use straight line.'
        ),
